...
export const CABINET_STYLES: CabinetStyleType[] = [
  ...
  { name: 'Naval', code: 'B7', fileName: 'B7-Naval.png', order: 7 },
  { name: 'Butterscotch', code: 'B8', fileName: 'B8-Butterscotch.png', order: 8 },
  { name: 'Greige', code: 'K3', fileName: 'K3-Greige.png', order: 9 },
  { name: 'Espresso', code: 'K8', fileName: 'K8-Espresso.png', order: 10 },
  { name: 'Mocha Glazed', code: 'K10', fileName: 'K10-MochaGlazed.png', order: 11 },
